/*
  ...
  1. New Tables
    - `channel_catalog` — global read-only master list of all OTA channels and
      ...
      - id, name, slug (unique), type, category, description, website_url,
        logo_color, logo_letter, commission_typical, regions[], popularity_rank, active

  2. Security
    - RLS disabled: catalog is global, not per-tenant data.
...
('Lodgify',         'lodgify',         'lodgify',         'channel_manager', 'Website builder and channel manager',             'https://lodgify.com',       '#7C3AED', 'LO', 0.0, array['global'],          3),
...
('iGMS',            'igms',            'igms',            'channel_manager', 'Vacation rental management software',             'https://igms.com',          '#6C63FF', 'IG', 0.0, array['global'],          9),
...
('Walk-in',                  'walk_in',            'direct',    'direct',    'In-person reservations at front desk',         null, '#6366F1', 'WI',  0.0, array['global'], 2),
('Phone / Email',            'phone_email',        'direct',    'direct',    'Reservations taken by phone or email',         null, '#8B5CF6', 'PE',  0.0, array['global'], 3),
('Travel Agent',             'travel_agent',       'corporate', 'corporate', 'Traditional travel agency bookings',           null, '#F59E0B', 'TA', 10.0, array['global'], 4),
('Corporate Contract',       'corporate_contract', 'corporate', 'corporate', 'Direct corporate rate agreements',             null, '#0EA5E9', 'CC',  5.0, array['global'], 5)
