/*
  ...
  This prevents sequential scans when Postgres enforces referential integrity or
  when joining on these columns, improving query performance across the board.

  ## Tables Affected
  - activity_log, ai_price_suggestions, booking_com_room_mappings,
    booking_com_settings, booking_com_sync_logs, booking_engine_config,
    channel_sync_logs, cloudbeds_room_mappings, cloudbeds_settings,
    cloudbeds_sync_logs, competitor_rates, direct_bookings,
    expedia_room_mappings, expedia_settings, expedia_sync_logs,
    guest_communications, guest_documents, guest_portal_sessions,
    guest_stay_history, housekeeping_staff, invoice_items,
    invoice_line_items, invoice_lines, invoice_settings,
    lodgify_room_mappings, lodgify_settings, lodgify_sync_logs,
    maintenance_issues, owner_properties, owner_statements,
    payments, pre_arrival_forms, pricing_rules, property_owners,
    siteminder_room_mappings, siteminder_settings, siteminder_sync_logs,
    upsell_items, upsell_orders, user_hotel_assignments
*/
